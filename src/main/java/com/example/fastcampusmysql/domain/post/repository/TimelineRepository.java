...
public class TimelineRepository {
    ...
    static final private RowMapper<Timeline> ROW_MAPPER = (ResultSet resultSet, int numRow) -> Timeline
            .builder()
    ...
    public void bulkInsert(List<Timeline> timeline) {
        ...
        SqlParameterSource[] params = timeline.stream().map(BeanPropertySqlParameterSource::new).toArray(SqlParameterSource[]::new);
